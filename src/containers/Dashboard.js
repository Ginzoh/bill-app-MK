...
export default class {
  ...
  handleShowTickets(e, bills, index) {
    ...
    bills.forEach((bill) => {
      switch (index) {
        case 1:
          this.checkBill(bill, bills, 1);
          break;

        case 2:
          this.checkBill(bill, bills, 2);
          break;

        case 3:
          this.checkBill(bill, bills, 3);
          break;
  ...
  checkBill(bill, bills, num) {
    ...
    switch (num) {
      ...
      default:
        console.log("Please use checkbill with 1, 2 or 3");
    }
